...
function template_body_above()
{
	...
	<div id="header">
		<h1 class="forumtitle">
			<a id="top" href="', $scripturl, '">', empty($context['header_logo_url_html_safe']) ? '<img src="'. $settings['images_url']. '/logo.png" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" />' : '<img src="' . $context['header_logo_url_html_safe'] . '" alt="' . $context['forum_name'] . '" title="' . $context['forum_name'] . '" />', '</a>
		</h1>';
    ...
    echo '
		<div id="s_bar">
			...
			echo '
				<li><a class="icons_social twitter" href="', $settings['twitter_url'] , '" target="_blank"></a></li>';

			if(!empty($settings['facebook_url']))
			echo '
				<li><a class="icons_social facebook" href="', $settings['facebook_url'] , '" target="_blank"></a></li>';

			if(!empty($settings['youtube_url']))
			echo '
				<li><a class="icons_social youtube" href="', $settings['youtube_url'] , '" target="_blank"></a></li>';

			if(!empty($settings['google_url']))
			echo '
				<li><a class="icons_social google" href="', $settings['google_url'] , '" target="_blank"></a></li>';

			echo '
				<li><a class="icons_social rss" href="', empty($settings['rss_url']) ? '' . $scripturl . '?action=.xml;type=rss' : '' . $settings['rss_url'] . '', '" target="_blank"></a></li>';
...
function template_body_below()
{
	...
	// Theme copyright MUST remain intact at all times.
		echo '
		<ul>
			...
			<li class="mycopyright">', $txt['smart_rights'], ' <a href="https://www.simpleforums.net/" target="_blank">', $txt['smart_link'], '</a></li>
		</ul>';
